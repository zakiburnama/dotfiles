-- Amber CRT terminal, matching QuickMenu Light's own amber theme
-- (ahk/quickmenu repo) 1:1. Hand-written rather than an installed plugin
-- -- no existing Neovim colorscheme matches this exact monochrome look
-- closely enough, and this avoids adding a plugin dependency just for
-- one theme (existing ones like amberchrome/vim-amber use their own,
-- slightly different amber). Managed by QuickMenu Light's global theme
-- switcher; see that repo's README.md ("Global themes") for how/why.

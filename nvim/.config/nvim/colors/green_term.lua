-- Phosphor-green CRT terminal, matching QuickMenu Light's own green_term
-- theme (ahk/quickmenu repo) 1:1. Hand-written rather than an installed
-- plugin -- no existing Neovim colorscheme matches this exact monochrome
-- look, and this avoids adding a plugin dependency just for one theme.
-- Managed by QuickMenu Light's global theme switcher; see that repo's
-- README.md ("Global themes") for how/why.
...
vim.g.colors_name = "green_term"

local bg = "#0A0A0A"
local bg_alt = "#1A1A1A"
local fg = "#33FF33"
local fg_dim = "#1A661A"
local fg_bright = "#99FF99"
local sel_bg = "#33FF33"
local sel_fg = "#0A0A0A"
